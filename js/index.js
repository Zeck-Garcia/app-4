...
function getUserPosition(){
    ...
    navigator.geolocation.getCurrentPosition((pos) => {
        ...
        url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&units=imperial&APPID=73db88fe2bbd7e61a490d513040806e4`
...
function fetchApi(url){
    ...
    .catch((err) => {
        city.innerText = 'Impossivel acessar o OpenWeather. Verifique a sua concexão'
